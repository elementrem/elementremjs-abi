...
Module implementing the Elementrem ABI in Javascript. Can be used with RPC libraries for communication or with elementremjs-vm to implement a fully fledged simulator.
...
Example code:
```js
var abi = require('elementremjs-abi')
